...
class ViewController: UIViewController {
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        ...
        if storyTextView.text == story1{
            ...
            if sender.tag == 1 {    //answer2a
                storyTextView.text = story3
                topButton.setTitle(answer3a, for: UIControlState.normal)
                bottomButton.setTitle(answer3b, for: .normal)
            } else if sender.tag == 2 {     //answer2b
            ...
            if sender.tag == 1 {    //answer3a
                storyTextView.text = story6
                changeButtonApperance()
            } else if sender.tag == 2 {     //answer3b
